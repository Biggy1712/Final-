...
<body>
    ...
    <div class="bigBox" style="height: fit-content !important;">
        <br>
        <h1 style="text-align: center;">ลงเวลาทุนช่วยงาน</h1> <br>
        <hr>
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="container1">
                <div class="row pt-2 ">
                    <div class="col ">
                        <label for="expend">user ที่ลงทะเบียน </label>
                        <input type="text" class="form-control" placeholder="user ที่ลงทะเบียน" name="user">
                    </div>
                    <div class="col "><label for="specifyexpend">ชื่อ นามสกุล</label>
                        <input type="text" class="form-control" placeholder="ชื่อ นามสกุล" name="name">
                    </div>
                </div>
                <div class="row pt-2">
                    <div class="col"><label for="joiner">งาน</label>
                        <input type="text" class="form-control" placeholder="งาน" name="work">
                    </div>
                    <div class="col"><label for="job">เวลางาน</label>
                        <input type="text" class="form-control" placeholder="เวลางาน" name="timework">
                    </div>
                </div>
                <!-- งาน 2 + 3 -->
                <!-- <div class="row pt-2">
                    <div class="col"><label for="job">งานที่2</label>
                        <input type="text" class="form-control" placeholder="งานที่2" name="work2">
                    </div>
                    <div class="col"><label for="job">เวลางานที่2</label>
                        <input type="text" class="form-control" placeholder="เวลางานที่2" name="timework2">
                    </div>
                </div>
                <div class="row pt-2">
                    <div class="col"><label for="job">งานที่3</label>
                        <input type="text" class="form-control" placeholder="งานที่3" name="work3">
                    </div>
                    <div class="col"><label for="job">เวลางานที่3</label>
                        <input type="text" class="form-control" placeholder="เวลางานที่3" name="timework3">
                    </div>
                </div> -->
                <!-- งาน 2 + 3 -->
                <div class="row pt-2">
                    <div class="col"><label for="workplace">ชื่ออาจารย์</label>
                        <input type="text" class="form-control" placeholder="ชื่ออาจาร" name="teachername">
                    </div>
