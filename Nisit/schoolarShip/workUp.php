        ...
        <div class="container mt-3">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="custom-file mb-3">
                    <input type="file" class="custom-file-input" id="filename1" name="filename1" require>
                ...
                <div class="custom-file mb-3">
                    <input type="file" class="custom-file-input" id="filename2" name="filename2" require>
                    <label class="custom-file-label" for="filename2">Choose file</label>
                </div>
                <p>ตารางเรียนปีการศึกษา :</p>
                <div class="custom-file mb-3">
                    <input type="file" class="custom-file-input" id="filename3" name="filename3" require>
                ...
                <div class="custom-file mb-3">
                    <input type="file" class="custom-file-input" id="filename4" name="filename4" require>
                    <label class="custom-file-label" for="filename4">Choose file</label>
                </div>


                <div class="mt-3">
                    <button onclick="myFunction()" type="submit" class="btn btn-primary" name="submit" value="Submit">Submit</button>
                </div>
                <script>
                    function myFunction() {
...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO work( user, nisitidcard_path, gpa_path, study_path, bank_path, time) 
                     VALUES ('" . $_SESSION['user'] . "', '$filepaths[0]','$filepaths[1]','$filepaths[2]','$filepaths[3]'," . time() . ")";
