...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO emergency( user,parent_path, nisitidcard_path, gpa_path, study_path, bank_path,parentid_path, time) 
    VALUES ('" . $_SESSION['user'] . "', '$filepaths[0]','$filepaths[1]','$filepaths[2]','$filepaths[3]','$filepaths[4]','$filepaths[5]'," . time() . ")";
