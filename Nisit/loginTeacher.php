...
<body>
    ...
    <div style="background-color: rgb(247 247 247);">
        <div class="centers">
            <div class="word">
                <h1><br>ระบบสมัครขอรับทุนการศึกษา<br>มหาวิทยาลัยเกษตรศาสตร์ วิทยาเขตศรีราชา</h1>
            </div>
            <div class="formss">
                <form class="modal-content animate" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <div class="container">
                        ...
                        <a style="text-align: center; margin-top: 0" href="http://localhost/intern/nisit/regisTeacher.php" type="submit" name="submit" value="true" class="btn btn-primary">click here to registration</a>
                    </div>
                    ...
                    if (isset($_POST['user']) && isset($_POST['pass'])) {
                        ...
                        $sql = "SELECT user,pass FROM teacher WHERE user='$user' and pass='$pass' ";
                        ...
                        if ($result) {
                            ...
                            if ($row = $result->fetch_assoc()) {
                                ...
                                if ($_SESSION['login3'] == "true") {
                                    ...
                                    header("Location: http://localhost/Intern/staff/clocktimestatus.php");
                                }
