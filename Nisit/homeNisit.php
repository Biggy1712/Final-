        ...
        <div class="row">
            <div class="column">
                <div class="card">
                    ...
                    <br>
                    <form action="http:\\localhost\Intern\Nisit\schoolarShip\tunasup.php">
                        <input class="btn btn-outline-success" type="submit" value="คลิกสมัคร" />
                    </form>
                    <br>
                </div>
            </div>
            ...
            <div class="column">
                <div class="card">
                    ...
                    <h3><a href="http://localhost/Intern/Nisit/clocktime.php">ลงเวลาทุนช่วยงานคณะ</a></h3>
                    <br>
                    <form action="http://localhost/Intern/Nisit/clocktime.php">
                        <input class="btn btn-outline-success" type="submit" value="ลงเวลา" />
                    </form>
                    <br>
                </div>
            </div>
            ...
            <div class="column">
                <div class="card">
                    ...
                    <h3><a href="http:\\localhost\Intern\Nisit\schoolarShip\emergency.php">ทุนฉุกเฉิน</a></h3>
                    <br>
                    <form action="http:\\localhost\Intern\Nisit\schoolarShip\emergency.php">
                        <input class="btn btn-outline-success" type="submit" value="คลิกสมัคร" />
                    </form>
                    <br>
                </div>
