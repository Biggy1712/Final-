            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if ($table == 'work') {
                    ...
                    if ($row['status3']) {
                        ...
                        echo "<th> <a href='http://localhost/Intern/staff/updateStats.php?id=" . $row['id'] . "&where=homeStaff3&which=status3&tunname=work&stats=true&table=" . $table . "'>ผ่าน<img class='centerimages' src='http://localhost/Intern/Nisit/resource/yes.png'   width='25' height='25'></a></th>";
                    }
                } elseif ($table == 'tunasup') {
                    ...
                    if ($row['status3']) {
                        ...
                        echo "<th> <a href='http://localhost/Intern/staff/updateStats.php?id=" . $row['id'] . "&where=homeStaff3&which=status3&tunname=tunasup&stats=true&table=" . $table . "'>ผ่าน<img class='centerimages' src='http://localhost/Intern/Nisit/resource/yes.png'   width='25' height='25'></a></th>";
                    }
                } elseif ($table == 'emergency') {
                    echo "<th><a href='http://localhost/Intern/show.php?tunname=tunasup&id= " . $row['id'] . " &user=" . $row['user'] . "&time=" . $row['time'] . "'>" . $row['user'] . "</a></th>";
                    $user = $row['user'];
                    ...
                    if ($row['status3']) {
                        ...
                        echo "<th> <a href='http://localhost/Intern/staff/updateStats.php?id=" . $row['id'] . "&where=homeStaff3&which=status3&tunname=emergency&stats=true&table=" . $table . "'>ผ่าน<img class='centerimages' src='http://localhost/Intern/Nisit/resource/yes.png'   width='25' height='25'></a></th>";
                    }
                }
                echo "</tr>";
            }
