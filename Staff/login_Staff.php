...
<body>
    ...
    <div style="background-color: rgb(247 247 247);">
        <div style="margin-left: 10% ;" class="centers">
            <div class="word">
                <h1><br>ระบบพนักงานสมัครขอรับทุนการศึกษา<br>มหาวิทยาลัยเกษตรศาสตร์ วิทยาเขตศรีราชา</h1>
            </div>
            <div class="formss">
                <form class="modal-content animate" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    if (isset($_POST['user']) && isset($_POST['pass'])) {
                        ...
                        $sql = "SELECT user,pass,name,tel  FROM staff  WHERE user='$user' and pass='$pass' ";
