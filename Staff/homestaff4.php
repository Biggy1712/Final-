...
<body>
    <div>
        <table id="myTable" class="display" style="width:90%;text-align:center;margin-left:auto;margin-right:auto;  border-collapse: collapse;  border: 1px solid black; ">
            ...
            $sql = "SELECT * FROM work where status5 IS NULL OR status5 = '' ";
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo ("
                        <th> 
                            <a href='http://localhost/Intern/staff/updateStats.php?id=" . $row['id'] . "&where=homeStaff4&which=status5&tunname=work&stats=true'>
                                ผ่าน 
