...
<body>
    <div>
        ...
        <table id="myTable" class="display" style="width:90%;text-align:center;margin-left:auto;margin-right:auto;  border-collapse: collapse;  border: 1px solid black; ">
            ...
            // echo ($table);
            $sql = "SELECT * FROM $table where status3 = 'true' order by user ";
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if ($table == 'work') {
                    ...
                    if ($row['status']) {
                        echo "<th> ผ่านคัดเลือก<img class='centerimages' src='http://localhost/Intern/Nisit/resource/yes.png'  width='25' height='25'></th>";
                    } else {
                    ...
                    if ($row['status']) {
                        echo "<th> ผ่านคัดเลือก<img class='centerimages' src='http://localhost/Intern/Nisit/resource/yes.png'  width='25' height='25'></a></th>";
                    } else {
